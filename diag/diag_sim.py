...
onnx.save(simplified, '../models/porting/BCResNet-t2-simplified.onnx')
...
# ONNX check
sess = ort.InferenceSession('../models/porting/BCResNet-t2-simplified.onnx')
...
rknn.load_onnx(model='../models/porting/BCResNet-t2-simplified.onnx')
rknn.build(do_quantization=False)
rknn.export_rknn('../models/porting/BCResNet-t2-simplified.rknn')
